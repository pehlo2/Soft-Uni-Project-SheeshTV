...
export const getFollowingUsers = async (profileId) => {
  const following = await request.get(`${endpoints.getOneUser}/${profileId}/following`)
  return following;
}


// export const getFollowers = async (profileId) => {
//   const followers = await request.get(`${endpoints.getOneUser}/${profileId}/followers`)
//   return followers;
// }
